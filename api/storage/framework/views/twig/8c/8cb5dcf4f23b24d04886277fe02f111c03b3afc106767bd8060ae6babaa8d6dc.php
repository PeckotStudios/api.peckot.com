...
/* user.base */
class __TwigTemplate_720f290e705cb843411488cef3994c7d85b05b99abe9f2be3822d3c2e491b354 extends \TwigBridge\Twig\Template
{
    private $source;
    private $macros = [];
...
<html lang=\"";
  ...
  <body class=\"";
    ...
    <div class=\"wrapper\">
      ...
      ";
        // line 11
        echo twig_include($this->env, $context, "shared.sidebar", ["scope" => "user"]);
        echo "
...
";
    ...
    {
        return new Source("", "user.base", "/www/wwwroot/mc.peckot.com/resources/views/user/base.twig");
    }
}
