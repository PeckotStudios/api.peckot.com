module.exports = (req, res) => {
    ...
    var _size = size.toLowerCase() == '1920x1080' ? '1920x1080' : Array.contains(new Array('1920x1200', '1366x768', '1280x768', '1024x768', '800x600', '800x480', '768x1280', '720x1280'), size.toLowerCase()) ? size.toLowerCase() : '1920x1080';
    ...
    axios.get(_url + '/HPImageArchive.aspx?cc=' + _area + '&format=js&idx=' + _dateback + '&n=' + _num).then(response => {
        console.log(new String(response.data))
